...
function ProductList({product}){
    ...
    return (
        <div className="bg-white text-center py-6 relative grid place-content-center" onClick={productPageHandler}>
            <img src={!secondaryImage ? primaryImage : otherImagesDtos[0].name} className="hover:cursor-pointer mb-4 h-96" alt='product' onMouseEnter={()=> showSecondaryImage((show)=>!show)} onMouseLeave={()=> showSecondaryImage((show)=>!show)}/>
